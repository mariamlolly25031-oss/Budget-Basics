      ...
      <section className="bg-white dark:bg-slate-900">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 dark:text-slate-400">
            Have a question about BudgetBasics? Send us a message
        ...
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-400">
              Whether you have a question, suggestion, or need help
              navigating the platform, you can reach out through
              the contact form.
            </p>
            ...
            {sent ? (
              ...
              <div className="py-12 text-center">
                ...
                <p className="mt-3 text-sm text-slate-600 dark:text-slate-400">
                  Thanks for contacting BudgetBasics.
                </p>
              ...
              <form onSubmit={(event) => {
                ...
                <div className="mt-6">
                  ...
                  <textarea
                    ...
                    required
                    className="w-full resize-none rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-slate-700 dark:bg-slate-950"
                  />
